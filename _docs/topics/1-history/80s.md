...
<div class="row">
    <div class="col-sm-4">        
    <img src="{{ "/assets/img/at-xenon.png" | relative_url }}" alt="Xenon" class="img-responsive">
    </div>        
    <div class="col-sm-4">            
    <img src="{{ "/assets/img/at-lemmings.png" | relative_url }}" alt="Lemmings" class="img-responsive">
    </div>
    <div class="col-sm-4">            
    <img src="{{ "/assets/img/at-civilization.png" | relative_url }}" alt="Civilization" class="img-responsive">
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">        
        <ul>
        <li>RAM 512 kilobytes</li>
        <li>Resolution 368x567 to 736x567</li>
        <li>CPU 7 MHz</li>
        <li>Floppy drive & mouse!</li>
        <li>£499 in 1987 </li>
        <li>£1500 in 2020 terms</li>
        </ul>
    </div>
    <div class="col-md-6">            
        <img src="{{ "/assets/img/amiga.jpg" | relative_url }}" alt="Atari ST" class="img-responsive">
    </div>
</div>
...
<div class="row">
    <div class="col-sm-4">        
    <img src="{{ "/assets/img/am-monkeyisland.png" | relative_url }}" alt="Monkey Island" class="img-responsive">
    </div>        
    <div class="col-sm-4">            
    <img src="{{ "/assets/img/am-simcity.png" | relative_url }}" alt="SimCity" class="img-responsive">
    </div>
    <div class="col-sm-4">            
    <img src="{{ "/assets/img/am-worms.png" | relative_url }}" alt="Worms" class="img-responsive">
    </div>
</div>

## The Rise Of The PC

Of course the Amiga and the Atari ST weren't the last of the home computers. They were instead the last of the home computers before the PC became dominant. The PC, or IBM PC Compatible, as they were known, became the only computer worth having for games in the early nineties.

## Consoles After The Crash

### Nintendo Entertainment System

The 1983 crash was terrible for the home console industry but it didn't kill it. Leading the recovery was Nintendo's Nintendo Entertainment System in 1985. The NES would become one of the best selling consoles of its time, selling over sixty million units by 2004.  

<div class="row">
    <div class="col-md-6">        
        <img src="{{ "/assets/img/nes.jpg" | relative_url }}" alt="Nintendo Entertainment System NES" class="img-responsive">
    </div>
    <div class="col-md-6">            
        <img src="{{ "/assets/img/master.jpg" | relative_url }}" alt="Sega Master System" class="img-responsive">
    </div>
</div>

The Sega Master System was also released in 1985, in competition with the NES. It wasn't as successful as the NES, with fewer sales and fewer games available, but it did lead to a much more successful console, the Sega Genesis.

### Sega Genesis / Sega Mega Drive

First launched in 1988 the Sega Genesis was a fourth generation, 16-bit console. While the Genesis struggled against the NES in Japan it became very successful in North America and Europe. It also gave us one of the most enduring icons of gaming, Sonic the Hedgehog.

<div class="row">
    <div class="col-md-6">        
        <img src="{{ "/assets/img/megadrive.jpg" | relative_url }}" alt="Sega Megadrive" class="img-responsive">
    </div>
    <div class="col-md-6">            
        <img src="{{ "/assets/img/sonic.jpg" | relative_url }}" alt="Sonic the Hedgehog" class="img-responsive">
    </div>
</div>
